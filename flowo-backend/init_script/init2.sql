...
-- Sample Addresses
INSERT INTO Address (firebase_uid, recipient_name, phone_number, street_address, city, postal_code, country, is_default_shipping)
VALUES
('firebase_uid_john_doe', 'John Doe', '1234567890', '123 Flower Street', 'New York', '10001', 'USA', TRUE),
('firebase_uid_john_doe', 'John Doe', '1234567890', '456 Bloom Ave', 'New York', '10001', 'USA', FALSE);
...
-- Sample Cart
INSERT INTO Cart (firebase_uid, session_id, created_at, updated_at)
VALUES
('firebase_uid_john_doe', 'sess_abc123', NOW(), NOW());
...
VALUES
('firebase_uid_john_doe', 'john@example.com', 'John Doe', 1, 2, NOW(), 'Completed', 99.98, 15.00, 5.00, 89.98, 'Standard', 'Please deliver before noon.');
...
INSERT INTO LoyaltyProgram (firebase_uid, points_balance, last_updated)
VALUES
('firebase_uid_john_doe', 200, NOW());
...
-- Sample Review
INSERT INTO Review (product_id, firebase_uid, rating, comment, review_date)
VALUES
(1, 'firebase_uid_john_doe', 5, 'Beautiful bouquet and fast delivery!', NOW());

-- Sample User Product Interaction
INSERT INTO UserProductInteraction (firebase_uid, session_id, product_id, interaction_type, timestamp)
VALUES
('firebase_uid_john_doe', 'sess_abc123', 1, 'view', NOW()),
('firebase_uid_john_doe', 'sess_abc123', 1, 'add_to_cart', NOW());

-- Sample Reviews 
INSERT INTO Review (product_id, firebase_uid, rating, comment, review_date)
VALUES (1, 'firebase_uid_john_doe', 5, 'The product is very beautiful', NOW());
